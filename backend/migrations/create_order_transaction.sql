-- Migration: Create Order Transaction Function
-- Purpose: Atomically creates an order with all related records
...
'Atomically creates an order with items, payment link, notifications, inventory update, and cart clearing. 
