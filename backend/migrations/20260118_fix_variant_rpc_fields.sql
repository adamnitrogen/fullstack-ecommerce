-- Migration: Fix RPC functions to include variant_mode and variant description
-- Created: 2026-01-18

-- ============================================================================
-- 1. CREATE PRODUCT WITH VARIANTS (Fixed)
-- ============================================================================
...
BEGIN
    ...
    INSERT INTO products (
        ...
        COALESCE((p_product_data->>'delivery_charge')::decimal, 0),
        ...
        COALESCE((p_product_data->>'variant_mode')::variant_mode_type, 'UNIT'), -- ADDED
...
-- ============================================================================
-- 2. UPDATE PRODUCT WITH VARIANTS (Fixed)
-- ============================================================================
...
BEGIN
    ...
    UPDATE products SET
        ...
        delivery_charge = COALESCE((p_product_data->>'delivery_charge')::decimal, delivery_charge),
        ...
        variant_mode = COALESCE((p_product_data->>'variant_mode')::variant_mode_type, variant_mode) -- ADDED
        ...
        FOREACH v_variant IN ARRAY p_variants LOOP
            IF v_variant ? 'id' AND v_variant->>'id' != '' THEN
                ...
                UPDATE product_variants SET
                    ...
                    description = COALESCE(v_variant->>'description', description), -- ADDED
                    ...
                    delivery_charge = CASE WHEN v_variant ? 'delivery_charge' THEN (v_variant->>'delivery_charge')::decimal ELSE delivery_charge END,
